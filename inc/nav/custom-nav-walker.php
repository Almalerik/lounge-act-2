...
class LoungeAct_Walker extends Walker_Nav_Menu {
	...
	function start_el(&$output, $item, $depth = 0, $args = Array (), $id = 0) {
		...
		if (strcasecmp ( $item->attr_title, 'divider' ) == 0 && $depth === 1) {
			...
			$item_output .= ($args->has_children) ? ' <div class="loungeact-open-submenu-wrapper"><span class="glyphicon glyphicon-triangle-bottom loungeact-open-submenu" aria-hidden="true"></span></div></a>' : '</a>';
