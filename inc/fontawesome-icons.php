...
$fa_icon = array (
		...
		'signal' => 'fa fa-signal',
		'gearfa fa-cog' => 'fa fa-gearfa fa-cog',
		...
		'list' => 'fa fa-list',
		'dedentfa fa-outdent' => 'fa fa-dedentfa fa-outdent',
		'indent' => 'fa fa-indent',
		'video-camera' => 'fa fa-video-camera',
		'photofa fa-imagefa fa-picture-o' => 'fa fa-photofa fa-imagefa fa-picture-o',
		'pencil' => 'fa fa-pencil',
		...
		'mail-forwardfa fa-share' => 'fa fa-mail-forwardfa fa-share',
		'expand' => 'fa fa-expand',
		...
		'warningfa fa-exclamation-triangle' => 'fa fa-warningfa fa-exclamation-triangle',
		'plane' => 'fa fa-plane',
		...
		'facebook-ffa fa-facebook' => 'fa fa-facebook-ffa fa-facebook',
		'github' => 'fa fa-github',
		'unlock' => 'fa fa-unlock',
		'credit-card' => 'fa fa-credit-card',
		'feedfa fa-rss' => 'fa fa-feedfa fa-rss',
		'hdd-o' => 'fa fa-hdd-o',
		...
		'groupfa fa-users' => 'fa fa-groupfa fa-users',
		'chainfa fa-link' => 'fa fa-chainfa fa-link',
		'cloud' => 'fa fa-cloud',
		'flask' => 'fa fa-flask',
		'cutfa fa-scissors' => 'fa fa-cutfa fa-scissors',
		'copyfa fa-files-o' => 'fa fa-copyfa fa-files-o',
		'paperclip' => 'fa fa-paperclip',
		'savefa fa-floppy-o' => 'fa fa-savefa fa-floppy-o',
		'square' => 'fa fa-square',
		'naviconfa fa-reorderfa fa-bars' => 'fa fa-naviconfa fa-reorderfa fa-bars',
		...
		'unsortedfa fa-sort' => 'fa fa-unsortedfa fa-sort',
		'sort-downfa fa-sort-desc' => 'fa fa-sort-downfa fa-sort-desc',
		'sort-upfa fa-sort-asc' => 'fa fa-sort-upfa fa-sort-asc',
		'envelope' => 'fa fa-envelope',
		'linkedin' => 'fa fa-linkedin',
		'rotate-leftfa fa-undo' => 'fa fa-rotate-leftfa fa-undo',
		'legalfa fa-gavel' => 'fa fa-legalfa fa-gavel',
		'dashboardfa fa-tachometer' => 'fa fa-dashboardfa fa-tachometer',
		'comment-o' => 'fa fa-comment-o',
		'comments-o' => 'fa fa-comments-o',
		'flashfa fa-bolt' => 'fa fa-flashfa fa-bolt',
		'sitemap' => 'fa fa-sitemap',
		'umbrella' => 'fa fa-umbrella',
		'pastefa fa-clipboard' => 'fa fa-pastefa fa-clipboard',
		...
		'laptop' => 'fa fa-laptop',
		'tablet' => 'fa fa-tablet',
		'mobile-phonefa fa-mobile' => 'fa fa-mobile-phonefa fa-mobile',
		'circle-o' => 'fa fa-circle-o',
		'quote-left' => 'fa fa-quote-left',
		'quote-right' => 'fa fa-quote-right',
		'spinner' => 'fa fa-spinner',
		'circle' => 'fa fa-circle',
		'mail-replyfa fa-reply' => 'fa fa-mail-replyfa fa-reply',
		...
		'code' => 'fa fa-code',
		'mail-reply-allfa fa-reply-all' => 'fa fa-mail-reply-allfa fa-reply-all',
		'star-half-emptyfa fa-star-half-fullfa fa-star-half-o' => 'fa fa-star-half-emptyfa fa-star-half-fullfa fa-star-half-o',
		'location-arrow' => 'fa fa-location-arrow',
		'crop' => 'fa fa-crop',
		'code-fork' => 'fa fa-code-fork',
		'unlinkfa fa-chain-broken' => 'fa fa-unlinkfa fa-chain-broken',
		...
		'toggle-downfa fa-caret-square-o-down' => 'fa fa-toggle-downfa fa-caret-square-o-down',
		'toggle-upfa fa-caret-square-o-up' => 'fa fa-toggle-upfa fa-caret-square-o-up',
		'toggle-rightfa fa-caret-square-o-right' => 'fa fa-toggle-rightfa fa-caret-square-o-right',
		'eurofa fa-eur' => 'fa fa-eurofa fa-eur',
		'gbp' => 'fa fa-gbp',
		'dollarfa fa-usd' => 'fa fa-dollarfa fa-usd',
		'rupeefa fa-inr' => 'fa fa-rupeefa fa-inr',
		'cnyfa fa-rmbfa fa-yenfa fa-jpy' => 'fa fa-cnyfa fa-rmbfa fa-yenfa fa-jpy',
		'rublefa fa-roublefa fa-rub' => 'fa fa-rublefa fa-roublefa fa-rub',
		'wonfa fa-krw' => 'fa fa-wonfa fa-krw',
		'bitcoinfa fa-btc' => 'fa fa-bitcoinfa fa-btc',
		'file' => 'fa fa-file',
		...
		'female' => 'fa fa-female',
		'male' => 'fa fa-male',
		'gittipfa fa-gratipay' => 'fa fa-gittipfa fa-gratipay',
		'sun-o' => 'fa fa-sun-o',
		'moon-o' => 'fa fa-moon-o',
		...
		'toggle-leftfa fa-caret-square-o-left' => 'fa fa-toggle-leftfa fa-caret-square-o-left',
		'dot-circle-o' => 'fa fa-dot-circle-o',
		'wheelchair' => 'fa fa-wheelchair',
		'vimeo-square' => 'fa fa-vimeo-square',
		'turkish-lirafa fa-try' => 'fa fa-turkish-lirafa fa-try',
		...
		'openid' => 'fa fa-openid',
		'institutionfa fa-bankfa fa-university' => 'fa fa-institutionfa fa-bankfa fa-university',
		'mortar-boardfa fa-graduation-cap' => 'fa fa-mortar-boardfa fa-graduation-cap',
		'yahoo' => 'fa fa-yahoo',
		'google' => 'fa fa-google',
		'reddit' => 'fa fa-reddit',
		...
		'automobilefa fa-car' => 'fa fa-automobilefa fa-car',
		'cabfa fa-taxi' => 'fa fa-cabfa fa-taxi',
		'tree' => 'fa fa-tree',
		...
		'file-photo-ofa fa-file-picture-ofa fa-file-image-o' => 'fa fa-file-photo-ofa fa-file-picture-ofa fa-file-image-o',
		'file-zip-ofa fa-file-archive-o' => 'fa fa-file-zip-ofa fa-file-archive-o',
		'file-sound-ofa fa-file-audio-o' => 'fa fa-file-sound-ofa fa-file-audio-o',
		'file-movie-ofa fa-file-video-o' => 'fa fa-file-movie-ofa fa-file-video-o',
		'file-code-o' => 'fa fa-file-code-o',
		'vine' => 'fa fa-vine',
		'codepen' => 'fa fa-codepen',
		'jsfiddle' => 'fa fa-jsfiddle',
		'life-bouyfa fa-life-buoyfa fa-life-saverfa fa-supportfa fa-life-ring' => 'fa fa-life-bouyfa fa-life-buoyfa fa-life-saverfa fa-supportfa fa-life-ring',
		'circle-o-notch' => 'fa fa-circle-o-notch',
		'rafa fa-rebel' => 'fa fa-rafa fa-rebel',
		'gefa fa-empire' => 'fa fa-gefa fa-empire',
		'git-square' => 'fa fa-git-square',
		'git' => 'fa fa-git',
		'y-combinator-squarefa fa-yc-squarefa fa-hacker-news' => 'fa fa-y-combinator-squarefa fa-yc-squarefa fa-hacker-news',
		'tencent-weibo' => 'fa fa-tencent-weibo',
		'qq' => 'fa fa-qq',
		'wechatfa fa-weixin' => 'fa fa-wechatfa fa-weixin',
		'sendfa fa-paper-plane' => 'fa fa-sendfa fa-paper-plane',
		'send-ofa fa-paper-plane-o' => 'fa fa-send-ofa fa-paper-plane-o',
		...
		'bomb' => 'fa fa-bomb',
		'soccer-ball-ofa fa-futbol-o' => 'fa fa-soccer-ball-ofa fa-futbol-o',
		'tty' => 'fa fa-tty',
		...
		'cc' => 'fa fa-cc',
		'shekelfa fa-sheqelfa fa-ils' => 'fa fa-shekelfa fa-sheqelfa fa-ils',
		...
		'intersexfa fa-transgender' => 'fa fa-intersexfa fa-transgender',
		...
		'hotelfa fa-bed' => 'fa fa-hotelfa fa-bed',
		'viacoin' => 'fa fa-viacoin',
		'train' => 'fa fa-train',
		'subway' => 'fa fa-subway',
		'medium' => 'fa fa-medium',
		'ycfa fa-y-combinator' => 'fa fa-ycfa fa-y-combinator',
		'optin-monster' => 'fa fa-optin-monster',
		'opencart' => 'fa fa-opencart',
		'expeditedssl' => 'fa fa-expeditedssl',
		'battery-4fa fa-battery-full' => 'fa fa-battery-4fa fa-battery-full',
		'battery-3fa fa-battery-three-quarters' => 'fa fa-battery-3fa fa-battery-three-quarters',
		'battery-2fa fa-battery-half' => 'fa fa-battery-2fa fa-battery-half',
		'battery-1fa fa-battery-quarter' => 'fa fa-battery-1fa fa-battery-quarter',
		'battery-0fa fa-battery-empty' => 'fa fa-battery-0fa fa-battery-empty',
		...
		'hourglass-1fa fa-hourglass-start' => 'fa fa-hourglass-1fa fa-hourglass-start',
		'hourglass-2fa fa-hourglass-half' => 'fa fa-hourglass-2fa fa-hourglass-half',
		'hourglass-3fa fa-hourglass-end' => 'fa fa-hourglass-3fa fa-hourglass-end',
		'hourglass' => 'fa fa-hourglass',
		'hand-grab-ofa fa-hand-rock-o' => 'fa fa-hand-grab-ofa fa-hand-rock-o',
		'hand-stop-ofa fa-hand-paper-o' => 'fa fa-hand-stop-ofa fa-hand-paper-o',
		...
		'tvfa fa-television' => 'fa fa-tvfa fa-television',
		'contao' => 'fa fa-contao',
		'500px' => 'fa fa-500px',
		'amazon' => 'fa fa-amazon',
